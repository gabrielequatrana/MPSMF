...
getSymbols(treasury_ticker, src = "FRED", from = "2023-08-15", to = "2023-08-15")
...
# Compute and save Annualized Risk-Free Rate
...
getSymbols(treasury_ticker, src = "FRED", from = "2020-08-15", to = "2023-08-15")

# Compute and save 10-Year Risk-Free Rate
